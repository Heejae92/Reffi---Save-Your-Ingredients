        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: ReffiSpace.s6) {
                    Text("Effective date: September 13, 2026").reffiType(.caption)
                    ...
                    section("Links, video searches and inquiries", "Tapping Videos opens a YouTube search in the current app language. The query can contain a recipe or ingredient name, including a name you entered. YouTube and Google may process the search, connection information and cookies under their own privacy policy. Opening our website connects your browser to its hosting provider, Vercel, which processes web requests and connection information. Our homepage loads Google Fonts and an OKDandan font from jsDelivr, sending font requests and connection information to those providers. Sending a privacy inquiry gives the operators your email address, message and chosen attachments through Gmail, provided by Google LLC. We use inquiries to respond, verify requests when necessary and protect user rights. These providers operate internationally, including in the United States, and information may be processed outside your country. You can avoid these optional transfers by not opening external links or sending email. Local inventory functions remain available. Do not email passwords or unnecessary sensitive information.")
