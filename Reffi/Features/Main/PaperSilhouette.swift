...
var c = paperContext(ctx, in:r)
        // 짧은 줄기 하나 + 어깨에 얹힌 짧은 꽃받침 다섯 갈래(63차: 갈라진 줄기·긴 별 꽃받침이 "이상해 보인다"는 오너 피드백).
        cut(&c,[(49,26),(47,15),(50,8),(56,9),(58,16),(55,27)],C.dGreen)
        ...
        cut(&c,[(21,44),(27,33),(37,26),(41,30),(32,38),(26,50)],C.tomatoHi.opacity(0.55))
        layeredCut(&c,[(41,16),(52,23),(63,15),(57,26),(71,33),(55,32),(54,44),(49,32),(33,34),(47,27)],C.dGreen)
    }
