...
final class IngredientDropScene: SKScene, SKPhysicsContactDelegate {
    ...
    private static let bodyMetrics: [FoodGlyph: (w: CGFloat, h: CGFloat, dy: CGFloat)] = [
        ...
        .apple: (0.5564, 0.6095, 0.0000),  .citrus: (0.6095, 0.5114, 0.0727), .berry: (0.5032, 0.6177, 0.0091),
        .avocado: (0.4745, 0.6464, 0.0250), .banana: (0.5686, 0.6095, -0.0091), .egg: (0.5564, 0.5318, 0.0432),
        .tofu: (0.5236, 0.5277, 0.0318),  .meat: (0.5891, 0.5236, 0.0068),  .poultry: (0.5564, 0.5727, 0.0114),
        .fish: (0.6218, 0.4009, -0.0341),   .shrimp: (0.5441, 0.5809, -0.0023), .milk: (0.3764, 0.6341, 0.0091),
        .cheese: (0.5564, 0.4868, 0.0591), .bread: (0.5155, 0.5850, 0.0227), .rice: (0.5686, 0.5155, 0.0750),
        .noodles: (0.5727, 0.4950, 0.0864), .corn: (0.5073, 0.6341, 0.0182), .sauceBottle: (0.3273, 0.6259, 0.0045),
        .can: (0.4664, 0.5277, 0.0364),
        // 기존 재료 재작업: 220 px 알파 bbox × 0.90, bbox 중심 정렬.
        .eggplant: (0.4173, 0.6627, -0.0068), .sweetPotato: (0.5973, 0.4664, 0.0614), .ginger: (0.5645, 0.5605, 0.0091),
        .seaweed: (0.5564, 0.6055, 0.0250), .grape: (0.5032, 0.6709, 0.0250), .watermelon: (0.6177, 0.5195, 0.0818),
        .pineapple: (0.4459, 0.6873, -0.0114), .mango: (0.5277, 0.5768, 0.0091), .sausage: (0.5809, 0.4377, 0.0318),
        .bacon: (0.6095, 0.4786, 0.0136), .crab: (0.6464, 0.5645, 0.0068), .squid: (0.4909, 0.6505, 0.0227),
        .clam: (0.5973, 0.5400, 0.0068), .yogurt: (0.4582, 0.5605, 0.0500), .butter: (0.6464, 0.4786, 0.0500),
        .honey: (0.4009, 0.5686, 0.0364), .dumpling: (0.5850, 0.4459, 0.0591),
        .gimbap: (0.72, 0.71, -0.01),
        // Expanded artwork: measured alpha bounds at 220 px, inset by the existing 0.90 fill.
        .scallion: (0.4418, 0.6914, 0.0045),
        .radish: (0.3805, 0.6791, 0.0114),
        .beet: (0.3805, 0.6791, 0.0114),
        .lotusRoot: (0.5809, 0.5523, 0.0227),
        .burdock: (0.4336, 0.5932, -0.0045),
        .enoki: (0.5686, 0.5564, 0.0341),
        .napa: (0.5441, 0.6177, 0.0273),
        .sprout: (0.5727, 0.5686, 0.0045),
        .bokChoy: (0.5441, 0.6177, 0.0273),
        .asparagus: (0.4009, 0.6914, -0.0364),
        .celery: (0.5809, 0.5605, -0.0045),
        .cauliflower: (0.5564, 0.5645, 0.0250),
        .pear: (0.4377, 0.6382, -0.0023),
        .peach: (0.5277, 0.6055, -0.0068),
        .blueberry: (0.5645, 0.4868, 0.0136),
        .cherry: (0.5645, 0.6300, -0.0068),
        .kiwi: (0.5809, 0.5850, 0.0091),
        .melon: (0.5973, 0.6136, 0.0068),
        .orange: (0.6136, 0.6505, -0.0136),
        .lime: (0.6136, 0.6505, -0.0136),
        .salmon: (0.5523, 0.4827, -0.0023),
        .octopus: (0.6218, 0.5686, -0.0273),
        .fishCake: (0.5564, 0.4786, -0.0091),
        .kimchi: (0.5891, 0.5605, 0.0273),
        .riceCake: (0.4745, 0.5809, 0.0386),
        .flour: (0.4173, 0.5564, 0.0205),
        .grains: (0.5768, 0.4623, 0.0045),
        .spice: (0.4500, 0.6136, -0.0023),
        .beans: (0.5727, 0.5523, 0.0045),
        .nuts: (0.5809, 0.5768, -0.0045),
        .walnut: (0.6177, 0.5727, 0.0023),
        .jar: (0.4500, 0.6136, -0.0023),
        .oil: (0.3027, 0.6136, -0.0023),
        .water: (0.3027, 0.6136, -0.0023),
        .coffee: (0.5564, 0.4705, 0.0455),
        .tea: (0.5564, 0.4705, 0.0455),
        .juice: (0.3682, 0.5564, -0.0023),
        .chocolate: (0.5236, 0.5973, 0.0386),
        .olive: (0.5727, 0.5768, 0.0045),
        .driedFruit: (0.5645, 0.5850, 0.0045),
        .cornDog: (0.3191, 0.6545, 0.0250),
        .ricePaper: (0.6259, 0.5523, -0.0045),
        .iceCream: (0.4255, 0.6218, 0.0250),
        .salt: (0.4500, 0.6136, -0.0023),
        .peppercorn: (0.4500, 0.6136, -0.0023),
        .curryPowder: (0.4500, 0.6136, -0.0023),
        .cinnamon: (0.4541, 0.5686, 0.0136),
        .starAnise: (0.6014, 0.6218, 0.0205),
        .wasabi: (0.4500, 0.6136, -0.0023),
