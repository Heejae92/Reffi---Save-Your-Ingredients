...
for country in ['ALL', 'KR', 'US']:
    ...
    totals = {k: sum(r[k] for r in selected) for k in ['targets','recovered','correctCandidates','emitted','oracleRecovered','automatic','correctAutomatic']}
